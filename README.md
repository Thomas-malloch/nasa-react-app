...
This project is a React web application that displays NASA’s Astronomy Picture of the Day (APOD) using NASA’s public API. Each day, the app fetches and presents the latest astronomy image along with its title, description, and date in a simple, responsive layout.
